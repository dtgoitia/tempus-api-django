    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('loop_index', models.IntegerField(validators=[src.plan.models.is_positive_number])),
                ('description', models.TextField(default='')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('entry_index', models.IntegerField(validators=[src.plan.models.is_positive_number])),
                ('duration', models.IntegerField(null=True, validators=[src.plan.models.is_positive_number])),
