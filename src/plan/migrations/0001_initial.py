# Generated by Django 3.0.3 on 2020-02-21 11:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start', models.DateTimeField(help_text='Date and time at which the session started.')),
            ],
        ),
        migrations.CreateModel(
            name='Record',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('start', models.DateTimeField(help_text='Date and time at which the execution of the exercise started.')),
                ('end', models.DateTimeField(help_text='Date and time at which the execution of the exercise finished.')),
